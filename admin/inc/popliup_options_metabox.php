...
$display_options = get_post_meta( $post->ID, 'popli_display_options', true );
	...
	$hide_on_scrollup 			= ( isset( $display_options['hide_on_scrollup'] ) ) ? true : false;
...
<div id="popliDsiaplyOptionsHldr">
	...
	<div id="hideOnScrollUp" <?php if( 'scroll' != $appear_after_type  ) echo 'style="display:none;"'; ?> >
		<label>
			<input type="checkbox" name="display_options[hide_on_scrollup]" <?php if( $hide_on_scrollup ) echo 'checked';  ?>  value="1" /> 
